...
const sectionTopNews = (update)=>{
  ...
  let container = $('<section class="row"></div>');

  console.log(newsState.top);
  $.each(newsState.top, function(i, noticia){
    console.log('newsState-tip');
    console.log(noticia);
    console.log(i);
    let itemNews = content(noticia.title, noticia.brief, 'assets/img/news/' + noticia.url, noticia.classNews);
    container.append(itemNews);
    console.log(itemNews);
  });
  console.log(container);
  console.log(topNews);
  return topNews.append(container);
}
